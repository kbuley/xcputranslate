...
FROM --platform=${BUILDPLATFORM} kbuley/xcputranslate:v0.8.0 AS xcputranslate
...
```Dockerfile
COPY --from=kbuley/xcputranslate:v0.8.0 /xcputranslate /usr/local/bin/xcputranslate
```
...
VERSION=v0.8.0
ARCH=amd64
wget -O xcputranslate "https://github.com/kbuley/xcputranslate/releases/download/$VERSION/xcputranslate_$VERSION_linux_$ARCH"
...
▶️ [Create an issue](https://github.com/kbuley/xcputranslate/issues/new)!
